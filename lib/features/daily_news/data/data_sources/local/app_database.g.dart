...
abstract class $AppDatabseBuilderContract {
  /// Adds migrations to the builder.
  $AppDatabseBuilderContract addMigrations(List<Migration> migrations);

  /// Adds a database [Callback] to the builder.
  $AppDatabseBuilderContract addCallback(Callback callback);

  /// Creates the database and initializes it.
  Future<AppDatabse> build();
}
...
class $FloorAppDatabse {
  ...
  static $AppDatabseBuilderContract databaseBuilder(String name) =>
      _$AppDatabseBuilder(name);

  /// Creates a database builder for an in memory database.
  /// Information stored in an in memory database disappears when the process is killed.
  /// Once a database is built, you should keep a reference to it and re-use it.
  static $AppDatabseBuilderContract inMemoryDatabaseBuilder() =>
      _$AppDatabseBuilder(null);
}

class _$AppDatabseBuilder implements $AppDatabseBuilderContract {
